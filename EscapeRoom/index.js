...
while (userInput === "yes" || userInput === "y" || userInput === "true") {
    ...
    while (isAlive) {
        ...
        if (userInput.includes("look")) {
            ...
            inv.push("bottle");
        } else if (userInput.includes("drink") && inv.includes("bottle") || (userInput.includes("drink") && userInput.includes("bottle")) || (userInput.includes("drink") && userInput.includes("beer"))) {
